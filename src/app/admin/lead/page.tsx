...
import { MessageSquare, Check, Phone, X } from "lucide-react";
import { formatCHF, formatDateTime } from "@/lib/utils";

const STATUS_OPTIONS = [
  { value: "NEW", label: "Nuovo", cls: "badge-warning" },
  { value: "CONTACTED", label: "Contattato", cls: "badge" },
  { value: "CONFIRMED", label: "Confermato", cls: "badge-success" },
  { value: "LOST", label: "Perso", cls: "badge-danger" },
];
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="heading-2">Richieste / Lead</h1>
          <p className="text-sm text-gray-500 mt-1">{leads.length} richieste totali</p>
        </div>
        <select
          value={filter}
              ...
              <div className="flex flex-col lg:flex-row lg:items-center gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-4 text-xs text-gray-400">
                    ...
                    <span>
                      Auto: {lead.car?.brand} {lead.car?.model}
                    </span>
                    <span>Totale: {formatCHF(lead.totalEstimate)}</span>
